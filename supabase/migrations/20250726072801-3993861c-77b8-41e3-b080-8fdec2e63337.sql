...
DROP POLICY IF EXISTS "Users can view files they uploaded or have access to" ON public.files;
DROP POLICY IF EXISTS "Users can view activities for their files or files shared with" ON public.file_activities;
