...
- Chair users: `chair-COUNCILNAME@bmunis.com` (e.g., `chair-unsc@bmunis.com`)
- Admin users: `admin-NAME@bmunis.com` (e.g., `admin-john@bmunis.com`) 
- Press users: `press-NAME@bmunis.com` (e.g., `press-jane@bmunis.com`)
- R&T Admin users: `rt-admin-NAME@bmunis.com` (e.g., `rt-admin-sarah@bmunis.com`)
- Logistics users: `logistics-NAME@bmunis.com` (e.g., `logistics-alex@bmunis.com`)
- Member users: `member-COUNCIL-NAME@bmunis.com` (e.g., `member-hcc-john@bmunis.com`, `member-fcc-jane@bmunis.com`)
