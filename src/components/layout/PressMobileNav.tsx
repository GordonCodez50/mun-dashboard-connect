...
import { Menu, X, LayoutDashboard, Building, UserCheck, Settings, LogOut } from "lucide-react";
...
// Press Mobile Navigation Component
export const PressMobileNav: React.FC = () => {
  const [isOpen, setIsOpen] = useState(false);
  const location = useLocation();
  const { user, logout } = useAuth();
  
  // Only show for press users
  const isPress = user && user.council === 'PRESS';
