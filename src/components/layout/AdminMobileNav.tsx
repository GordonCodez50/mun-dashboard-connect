...
import { Menu, X, LayoutDashboard, UserCheck, FileText, Settings, LogOut, Building } from "lucide-react";
...
export const AdminMobileNav: React.FC = () => {
  ...
  // Show for admin and logistics users
  const isAdminOrLogistics = user && (user.role === 'admin' || user.role === 'logistics');
  
  if (!isAdminOrLogistics) return null;
