      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.div className="flex flex-col gap-2" variants={itemVariants}>
            ...
            >
              Experience BMUNIS 2025's next-generation management platform—purpose-built for Bahrain's leading MUN conference. From real-time council management to instant alerts and seamless document sharing, every feature is tailored to streamline your MUN experience and keep the focus on diplomacy, debate, and leadership.
            </motion.p>
          </motion.div>
