    ...
    <div className={`grid ${isMobile ? 'grid-cols-1 gap-3' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'}`}>
      ...
      >
        <Card className="h-full border-none bg-white/95 backdrop-blur-sm shadow-md">
          <CardHeader className={`${isMobile ? 'pb-1 px-3 pt-3' : 'pb-2'} bg-gradient-to-r from-primary/5 to-transparent`}>
            <CardTitle className={`${isMobile ? 'text-base' : 'text-lg'} font-medium`}>Attendance Overview</CardTitle>
          </CardHeader>
          <CardContent className={isMobile ? 'px-3 pb-3' : ''}>
            <div className={`space-y-${isMobile ? '3' : '4'}`}>
              <div className="flex justify-between items-center">
                <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-muted-foreground`}>Total Participants</div>
                <motion.div 
              ...
              <div className={`space-y-${isMobile ? '1.5' : '2'}`}>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`${isMobile ? 'text-xs' : 'text-sm'}`}>Present</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2">
                    <UserX className={`${isMobile ? 'h-3 w-3' : 'h-4 w-4'} text-red-500`} />
                    <span className={`${isMobile ? 'text-xs' : 'text-sm'}`}>Absent</span>
                  </div>
                  <div className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium`}>
                ...
                >
                  <div className="flex items-center gap-2">
                    <HelpCircle className={`${isMobile ? 'h-3 w-3' : 'h-4 w-4'} text-gray-500`} />
                    <span className={`${isMobile ? 'text-xs' : 'text-sm'}`}>Not Marked</span>
                  </div>
                  <div className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium`}>
      ...
      >
        <Card className="h-full border-none bg-white/95 backdrop-blur-sm shadow-md">
          <CardHeader className={`${isMobile ? 'pb-1 px-3 pt-3' : 'pb-2'} bg-gradient-to-r from-primary/5 to-transparent`}>
            <CardTitle className={`${isMobile ? 'text-base' : 'text-lg'} font-medium`}>Attendance Progress</CardTitle>
          </CardHeader>
          <CardContent className={isMobile ? 'px-3 pb-3' : ''}>
            <div className={`space-y-${isMobile ? '3' : '4'}`}>
              <div className={`space-y-${isMobile ? '1.5' : '2'}`}>
                ...
                <div className={`${isMobile ? 'h-1.5' : 'h-2'} bg-gray-100 rounded-full overflow-hidden`}>
                  <motion.div 
                ...
                <p className={`text-${isMobile ? '2xs' : 'xs'} text-muted-foreground`}>
                  {notMarkedCount} participants still need to be marked
                </p>
              </div>
              
              <div className={isMobile ? 'pt-2' : 'pt-4'}>
                <div className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium ${isMobile ? 'mb-1' : 'mb-2'}`}>Attendance Breakdown</div>
                <div className={`${isMobile ? 'h-3' : 'h-4'} w-full flex rounded-full overflow-hidden`}>
                  <motion.div 
                ...
                <div className={`flex justify-between ${isMobile ? 'mt-1' : 'mt-2'} text-${isMobile ? '2xs' : 'xs'} text-muted-foreground`}>
                  <span>Present</span>
                  <span></span>
                  <span>Absent</span>
                </div>
