...
export const extractUserInfo = (email: string) => {
  ...
  // Check if it's a name-admin email format
  else if (email.includes('-admin@bmunis.com')) {
    ...
    // Extract council name from chair-COUNCILNAME@bmunis.com
    ...
    // Extract name from admin-NAME@bmunis.com (if provided)
    ...
    // Extract name from press-NAME@bmunis.com (if provided)
