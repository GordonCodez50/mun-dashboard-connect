...
import { Wrench, MessagesSquare, Truck, AlertTriangle, Send, MessageSquare, BellRing, Menu, X } from 'lucide-react';
  ...
  if (isMobile) {
    return (
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900 relative">
        <div className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-800 z-40 border-b border-gray-200 dark:border-gray-700 px-4 h-14 flex items-center justify-between">
          ...
          <div className="font-semibold text-primary dark:text-white">Chair Dashboard</div>
          <button
            onClick={() => setAlertsMuted(!alertsMuted)}
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            aria-label={alertsMuted ? "Unmute Notifications" : "Mute Notifications"}
          >
            {alertsMuted ? (
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500">
                <line x1="1" y1="1" x2="23" y2="23"></line>
