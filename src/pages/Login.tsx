...
const Login = () => {
  ...
  const handleForgotPassword = () => {
    const emailSubject = "Password Reset Request - BMUNIS'25 Dashboard";
    const emailBody = `Hello BMUNIS Admin,

I would like to request a password reset for my BMUNIS'25 Dashboard account.
...
${email}`;
    ...
    const mailtoLink = `mailto:bmunis@bmunis.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
  ...
  return (
    <>
      <SEOHead 
        title="Login"
        description="Sign in to your BMUNIS Dashboard account. Access your Model United Nations conference management platform with secure authentication for chairs and administrators."
        canonicalUrl="/login"
      />
      <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-md px-4 z-10 animate-fade-in">
          <div className="text-center mb-8 animate-scale-in">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent tracking-tight mb-1 animate-fade-in animation-delay-200">BMUNIS'25</h1>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="youremail@bmunis.com"
                      value={email}
          ...
          <div className="text-center mt-8 text-sm text-gray-500 animate-fade-in animation-delay-500">
            <p>© {new Date().getFullYear()} BMUNIS. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
